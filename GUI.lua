...
title.Text = "Animation Hub - " .. AnimationCount .. " Animations & " .. EmoteCount .. " Emotes"
...
-- Crear botones para Animation Packs
local animSection = Instance.new("TextLabel")
animSection.Name = "AnimSection"
animSection.Size = UDim2.new(1, 0, 0, 25)
animSection.BackgroundTransparency = 1
animSection.Text = "ANIMATION PACKS:"
animSection.TextColor3 = Color3.fromRGB(255, 255, 255)
animSection.Font = Enum.Font.GothamBold
animSection.TextSize = 12
animSection.TextXAlignment = Enum.TextXAlignment.Left
animSection.Parent = scrollFrame

for i, packName in ipairs(AnimationPacksList) do
    local button = Instance.new("TextButton")
    button.Name = packName
    ...
    button.MouseButton1Click:Connect(function()
        ...
        RefreshAnimations()
        ShowSuccess("Animation Pack Applied", packName)
    end)
end

-- Crear botones para Emotes R15
local emoteSection = Instance.new("TextLabel")
emoteSection.Name = "EmoteSection"
emoteSection.Size = UDim2.new(1, 0, 0, 25)
emoteSection.BackgroundTransparency = 1
emoteSection.Text = "R15 EMOTES:"
emoteSection.TextColor3 = Color3.fromRGB(255, 255, 255)
emoteSection.Font = Enum.Font.GothamBold
emoteSection.TextSize = 12
emoteSection.TextXAlignment = Enum.TextXAlignment.Left
emoteSection.Parent = scrollFrame

for i, emoteName in ipairs(R15EmotesList) do
    local button = Instance.new("TextButton")
    ...
    button.MouseButton1Click:Connect(function()
        PlayEmoteByName(emoteName)
        ShowSuccess("Emote Playing", emoteName)
    end)
end

-- Botón para detener animaciones
...
stopButton.Text = "STOP ALL ANIMATIONS"
...
stopButton.MouseButton1Click:Connect(function()
    StopAllAnimations()
    ShowSuccess("Animations Stopped", "All animations have been stopped")
end)

-- Ajustar el tamaño del ScrollFrame
local function updateScrollSize()
    local ySize = 0
    for _, child in pairs(scrollFrame:GetChildren()) do
        if child:IsA("TextButton") or child:IsA("TextLabel") then
            ySize = ySize + child.Size.Y.Offset + listLayout.Padding.Offset
        end
    end
